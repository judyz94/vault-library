    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="borrowing-management">
                    <a href="#borrowing-management">Borrowing management</a>
                                ...
                                <a href="#borrowing-management-POSTapi-users--user_id--borrow">POST api/users/{user_id}/borrow</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="borrowing-management-POSTapi-users--user_id--return">
                                <a href="#borrowing-management-POSTapi-users--user_id--return">POST api/users/{user_id}/return</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="borrowing-management-GETapi-users--user_id--borrowed">
                                <a href="#borrowing-management-GETapi-users--user_id--borrowed">GET api/users/{user_id}/borrowed</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="user-management">
                    <a href="#user-management">User management</a>
                                ...
                                <a href="#user-management-GETapi-users--user_id-">GET api/users/{user_id}</a>
                            </li>
...
<p>API Documentation for managing users, books, and borrows in a library system.</p>
<aside>
...
<form id="form-GETapi-books-search" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-books-search');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-books-search"
                    onclick="cancelTryOut('GETapi-books-search');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>The search query for title, author name, or ISBN. Example: <code>clean</code></p>
                    ...
                    <h2 id="book-management-GETapi-books">GET api/books</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="book-management-GETapi-books--book_id-">GET api/books/{book_id}</h2>
...
<p>The ID of the book. Example: <code>1</code></p>
                    ...
                    <h2 id="book-management-POSTapi-books">POST api/books</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Title of the book. Must not be greater than 255 characters. Example: <code>The Pragmatic Programmer</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="author_id"                data-endpoint="POSTapi-books"
               value="1"
               data-component="body">
    <br>
<p>ID of the author who wrote the book. The <code>id</code> of an existing record in the authors table. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Indicates if the book is available for loan. Example: <code>false</code></p>
                    ...
                    <h2 id="book-management-PUTapi-books--id-">PUT api/books/{id}</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="author_id"                data-endpoint="PUTapi-books--id-"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 1000. Must not be greater than 2025. Example: <code>24</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>available</code></b>&nbsp;&nbsp;
<small>boolean</small>&nbsp;
...
<p>Example: <code>false</code></p>
                    ...
                    <h2 id="book-management-DELETEapi-books--id-">DELETE api/books/{id}</h2>
...
<p>The ID of the book. Example: <code>1</code></p>
    ...
    <p>APIs for managing book borrowings</p>
                                ...
                                <h2 id="borrowing-management-POSTapi-users--user_id--borrow">POST api/users/{user_id}/borrow</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://127.0.0.1:8000/api/users/1/borrow" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"book_id\": \"architecto\"
...
<form id="form-POSTapi-users--user_id--borrow" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-users--user_id--borrow');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-users--user_id--borrow"
                    onclick="cancelTryOut('POSTapi-users--user_id--borrow');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="book_id"                data-endpoint="POSTapi-users--user_id--borrow"
               value="architecto"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the books table. Example: <code>architecto</code></p>
                    ...
                    <h2 id="borrowing-management-POSTapi-users--user_id--return">POST api/users/{user_id}/return</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://127.0.0.1:8000/api/users/1/return" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"book_id\": \"architecto\"
...
<form id="form-POSTapi-users--user_id--return" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-users--user_id--return');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-users--user_id--return"
                    onclick="cancelTryOut('POSTapi-users--user_id--return');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="book_id"                data-endpoint="POSTapi-users--user_id--return"
               value="architecto"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the books table. Example: <code>architecto</code></p>
                    ...
                    <h2 id="borrowing-management-GETapi-users--user_id--borrowed">GET api/users/{user_id}/borrowed</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/users/1/borrowed" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/users/1/borrowed"
);
...
<form id="form-GETapi-users--user_id--borrowed" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-users--user_id--borrowed');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-users--user_id--borrowed"
                    onclick="cancelTryOut('GETapi-users--user_id--borrowed');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="user-management-GETapi-users--user_id-">GET api/users/{user_id}</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="library_id"                data-endpoint="POSTapi-users"
               value="n"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="library_id"                data-endpoint="PUTapi-users--id-"
               value="i"
               data-component="body">
    <br>
